...
const BookingSuccess = () => {
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))] from-blue-900 via-slate-900 to-black overflow-hidden relative">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-2xl border border-white/10 p-10 rounded-[3rem] shadow-2xl text-center z-10 border-b-green-500/30">
        
        {/* Animated Success Checkmark */}
        <div className="mb-8 flex justify-center">
          <div className="relative">
            <div className="absolute inset-0 bg-green-500/20 rounded-full animate-ping opacity-25"></div>
            <div className="w-24 h-24 bg-gradient-to-br from-green-500/20 to-emerald-500/10 rounded-full flex items-center justify-center border border-green-500/30 relative">
        ...
        <p className="text-gray-400 mb-8 leading-relaxed text-sm font-medium">
          ...
          Your appointment is being processed. Our team will contact you to confirm the time slot.
        </p>
        ...
        <div className="space-y-4">
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="flex items-center justify-center gap-3 w-full py-4 bg-white/5 border border-white/10 rounded-2xl text-white font-bold text-xs uppercase tracking-widest hover:bg-white/10 transition-all active:scale-95"
          >
          ...
          <Link 
            to="/" 
            className="inline-block text-[10px] text-gray-500 uppercase tracking-[0.3em] font-black hover:text-white transition-colors mt-4"
          >
            ← Back to Home
          </Link>
        </div>
      ...
      {/* Subtle Footer */}
      <p className="absolute bottom-10 text-gray-700 text-[9px] tracking-[0.5em] font-bold uppercase">© 2026 Auto-Care Elite Premium</p>
    </div>
  );
};
